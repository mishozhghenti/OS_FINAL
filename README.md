...
ხოლო წარმატებულად დაბრუნებული კოდის შემდეგ კი შეგვიძლია, გამოვიძახოთ log_message(char* msg)-რომელიც თავის მხრივ იყენებს init()-ის მიერ "მოპოვებულ" ფაილს და იქ წერს გადმოცემულ მესიჯს. აღსანიშნავია, რომ ყოველ log_message-ის გამოძახებისას გადმოეცემა მხოლოდ ტექსტი, და ეს მეთოდი კი ავტომატურად ლოგერ ფაილში ინახავს აღნიშნული ფორმატით თითოეულ ლოგს. მაგალითად:
```txt
